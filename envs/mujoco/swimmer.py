...
class SwimmerEnv(MujocoEnv, utils.EzPickle):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def step(self, action):
        ...
        return observation, reward, False, False, reward_components
    ...
    def compute_reward(self, states: np.ndarray, actions:np.ndarray):
        x_velocity, y_velocity = states[3], states[4]

        forward_reward = self._forward_reward_weight * x_velocity

        ctrl_cost = self.control_cost(actions[0])
